local PLATFORM_WIN32 = "1";
local PLATFORM_UNIX = "0";
...
local OPENGL_SRC_PLATFORM = "src/msw/glcanvas.cpp";
local OPENGL_SRC = {
	"src/common/glcmn.cpp",
	"src/msw/glcanvas.cpp"
};
local OPENGL_HDR_PLATFORM = "wx/msw/glcanvas.h";
local OPENGL_HDR = {
	"wx/glcanvas.h",
	"wx/msw/glcanvas.h"
};
...
local AUI_PLATFORM_SRC = {
	"src/aui/tabartmsw.cpp",
	"src/aui/barartmsw.cpp"
};
local AUI_PLATFORM_HDR = {
	"wx/aui/tabartmsw.h",
	"wx/aui/barartmsw.h"
};
local AUI_CMN_SRC = {
...
local BASE_AND_GUI_PLATFORM_SRC = {
	"src/msw/main.cpp",
	"src/msw/volume.cpp"
};
...
local _MAGICTABLE = {
	...
	AUI_PLATFORM_SRC = AUI_PLATFORM_SRC,
	AUI_PLATFORM_HDR = AUI_PLATFORM_HDR,
